# Generated by Django 5.0.3 on 2024-05-03 14:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='TblAddresses',
            fields=[
                ('id', models.UUIDField(db_column='address_uuid', default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tc_rent_sale', models.CharField(blank=True, choices=[('sale', 'sale'), ('rent', 'rent'), ('all', 'all')], db_column='tc_rent_sale', max_length=4, null=True, verbose_name='Аренда или продожа')),
